...
#TODO: with the sev-es kernel this has changed again. Not sure
#about the mechanism behind this. May this is because the sev-es kernel is built and
...
#edit magic number
#TODO: magic values already includes -offsetVmlinuzTextSection fix this
#TODO: in the config for sev-guests provided by amd CONFIG_RANDOIZE_BASE is not set and thus defaults
