...
textSectionNames=("urandom_read add_interrupt_randomness add_disk_randomness crng_reseed crng_backtrack_protect extract_crng get_random_bytes protection_map __handle_mm_fault alloc_pages_vma do_page_fault do_mmap __startup_64")
...
#edit magic number
paddr_choose_random_location=$((0x81E030 - $offsetVmlinuzTextSection + $paddrVmlinuzTextSection))
